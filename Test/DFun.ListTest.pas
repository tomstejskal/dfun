...
begin
  CheckEquals('[1, 2, 3, 2, 4, 6, 3, 6, 9]',
    List.ToStringWith<Integer>(IntToStr,
...
begin
  CheckEquals('[]', List.ToStringWith<Integer>(IntToStr, List.Empty<Integer>));
end;
...
begin
  ...
  CheckEquals('[[1], [4], [3, 3], [2, 2], [1], [4], [5]]',
    List.ToStringWith<IList<Integer>>(
      ...
      List.GroupBy<Integer>(
        function(X, Y: Integer): Integer begin Result := X - Y end,
        List.FromArray<Integer>([1, 4, 3, 3, 2, 2, 1, 4, 5]))));
  CheckEquals(1000,
...
procedure ListTest.TestSortAndGroupBy;
begin
  CheckEquals('[[1, 1, 1], [2, 2, 2], [3, 3, 3], [4, 4], [5]]',
    List.ToStringWith<IList<Integer>>(
      function(X: IList<Integer>): String begin
        Result := List.ToStringWith<Integer>(IntToStr, X);
      end,
      List.SortAndGroupBy<Integer>(
        function(X, Y: Integer): Integer begin Result := X - Y end,
        List.FromArray<Integer>([1, 2, 3, 4, 5, 1, 2, 3, 1, 2, 3, 4]))));
end;
